...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            version("hibernate", "7.4.10.Final")
            ...
            library("cloudExtras", "org.incendo", "cloud-minecraft-extras").version("2.0.1")
            library("commodore", "me.lucko", "commodore").version("2.2")

            //Caching
            library("caffeine", "com.github.ben-manes.caffeine", "caffeine").version("3.3.0")
            ...
            //Testing
            library("junitJupiterApi", "org.junit.jupiter", "junit-jupiter-api").version("6.1.3")
